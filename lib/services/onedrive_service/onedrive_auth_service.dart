...
///      "organization"/work account required just to REGISTER the app.
///    - Name: anything (e.g. "Fiş Tarayıcı").
///    - Supported account types: "Accounts in any organizational
///      directory and personal Microsoft accounts" (matches the
///      `AzureADandPersonalMicrosoftAccount` audience in
///      assets/msal_config.json). This lets users sign in with EITHER a
///      personal account OR a work/school (organizational) email —
///      registering the app yourself doesn't require you personally to
///      be part of an organization; this setting only controls which
///      account types END USERS can sign in with later.
